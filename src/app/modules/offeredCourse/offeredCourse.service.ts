...
const createOffredCourse = async (
...
const getAllOffredCourse = async (
...
const getSingleOffredCourse = async (
  id: string
...
const updateOffredCourse = async (
  id: string,
...
const deleteOffredCourse = async (id: string): Promise<OfferedCourse> => {
