...
import { SemesterRegistrationUtils } from './SemesterRegistrationUtils';

const createSemestrRegistration = async (
...
const getAllSemestrRegistration = async (
...
const getSingleSemestrRegistration = async (
  id: string
...
const updateSemestrRegistration = async (
  id: string,
...
const deleteSemestrRegistration = async (
  id: string
): Promise<SemesterRegistration> => {
