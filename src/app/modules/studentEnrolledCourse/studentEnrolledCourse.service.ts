...
const createStuentEnrolledCourse = async (
...
const getAllStuentEnrolledCourse = async (
...
const getSingleStuentEnrolledCourse = async (
  id: string
...
const updateStuentEnrolledCourse = async (
  id: string,
...
const deleteStuentEnrolledCourse = async (
  id: string
): Promise<StudentEnrolledCourse> => {
