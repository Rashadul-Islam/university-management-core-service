...
const createCourseClassScheduleZodSchema = z
  .object({
    body: z.object({
...
const updateCourseClassScheduleZodSchema = z.object({
  body: z.object({
...
export const OfferedCourseClassScheduleValidation = {
  createCourseClassScheduleZodSchema,
  updateCourseClassScheduleZodSchema,
};
