...
const craeteStudent = catchAsync(async (req: Request, res: Response) => {
  const result = await StudentService.craeteStudent(req.body);
...
const myCourses = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await StudentService.myCourses(req?.user?.userId, filter);
